        ...
        <div className="flex  justify-between items-center p-2 bg-[#d4d4d4] px-6 md:px-10 lg:px-14">
          <div className="flex items-center gap-8">
            <Dropdown menu={{ items: ordersMenuItems }} placement="bottom">
              <a
                ...
                className={`text-[14px] cursor-pointer text-[#ff4800] hover:text-[#f03200] ${selectedLink === "pedidos-banda-larga-pf"
            ...
            <Dropdown menu={{ items: clientsMenuItems }} placement="bottom">
              <a
                onClick={(e) => e.preventDefault()}
                className={`text-[14px] cursor-pointer text-[#ff4800] hover:text-[#f03200] ${selectedLink === "clientes-pj"
                  ? "font-bold text-[#f03200]"
                  : ""
                  }`}
              >
            ...
            <a
              ...
              className={`text-[14px] cursor-pointer text-[#ff4800] hover:text-[#f03200] ${selectedLink === "contatos" ? "font-bold text-[#f03200]" : ""
                }`}
            >
              Mensagens
            </a>
            ...
            <Dropdown menu={{ items: chatsMenuItems }} placement="bottom">
              <a className="text-[14px] cursor-pointer text-[#ff4800] hover:text-[#f03200]">
                Chatter
              </a>
            </Dropdown>
            ...
            <a
              ...
              className={`text-[14px] cursor-pointer text-[#ff4800] hover:text-[#f03200] ${selectedLink === "book-de-ofertas"
                ? "font-bold text-[#f03200]"
                : ""
                }`}
            >
            ...
            <Dropdown menu={{ items: toolsMenuItems }} placement="bottom">
              <a
                onClick={(e) => e.preventDefault()}
                className={`text-[14px] cursor-pointer text-[#ff4800] hover:text-[#f03200] ${selectedLink === "pj-checker" ||
          ...
          <div className="flex items-center gap-4">
            ...
            <Button
              ...
              className="logout-btn "
            >
              <LogoutOutlined style={{ color: "#ff4800" }} />
            </Button>
            <style>
              {`
